...
const getView = (isLoggedIn, firstName) => {
  switch (isLoggedIn) {
    case undefined:
      return <div className="popup-hero">loading...</div>;
    case true:
      return loggedInElem(firstName);
    default:
...
const Popup = () => {
  ...
  const { isLoggedIn, firstName } = user;
