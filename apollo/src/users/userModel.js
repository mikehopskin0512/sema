...
import { createUserCollection, getDefaultUserOrTeamCollectionList } from '../comments/collections/collectionService';
...
userSchema.pre('save', async function save(next) {
  ...
  try {
    ...
    if (this.isNew) {
      ...
      this.collections = await getDefaultUserOrTeamCollectionList(personalCollection._id);
    }
