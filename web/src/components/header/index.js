            ...
            <div className="navbar-menu" ref={menu}>
              ...
              >
                ...
                <Link href="/collections">
                  <a aria-hidden="true" className={`navbar-item has-text-deep-black mx-25 ${pathname.includes('/collections') || pathname.includes('/comments') ? 'has-text-weight-semibold' : ''}`} onClick={toggleHamburger}>
                    Suggested Comments
                  </a>
                </Link>
                <Link href="/guides">
