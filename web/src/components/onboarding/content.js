...
export const content = [
  ...
  },
  {
    ...
    subtitle: [
      ...
      'E.g., Awesome, Looks good, Needs a fix, I have a question.',
    ],
  ...
  },
  {
    ...
    subtitle: [
      'The Sema Chrome Extension makes code reviews more impactful. Please install it to continue.',
    ],
...
export const commentCollection = [
  {
    ...
    subtitle:
      'Frequently used statements and questions when conducting code reviews',
  ...
  },
  {
    title: 'Security',
    subtitle:
      'Mitre’s Common Weakness Enumeration (CWE): a community-developed list of software and hardware weakness types.',
    field: 'security',
  },
  {
    title: 'Functional review',
    subtitle:
      'Formal categorization of where the code as written does or does not meet the provided product requirements',
  ...
  },
  {
    title: 'Famous quotes',
    subtitle:
      'Quotes from famous people, real or pretend, that we think have something to say about code reviews ;0',
    field: 'famousQuotes',
  },
  {
    title: 'My Snippets',
