      ...
      <div className="columns">
        <div className="column is-8">
          <div className='is-flex is-align-items-center is-justify-content-space-between'>
            ...
            <button className="button has-text-blue-700 is-ghost is-pulled-right has-text-weight-semibold" onClick={() => router.push(`${PATHS.TEAMSS._}/${teamId}${PATHS.REPOS}`)}>View All</button>
          </div>
