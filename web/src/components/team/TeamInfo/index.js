  ...
  return (
    <div className="content-container px-10">
      <div className='is-flex is-align-items-center is-justify-content-space-between'>
        ...
        {isTeamAdmin() && <button className="button is-primary is-outlined is-pulled-right has-text-weight-semibold" onClick={() => router.push(PATHS.TEAM.EDIT(activeTeam._id))}>Edit</button>}
      </div>
