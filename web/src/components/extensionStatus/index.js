...
const ExtensionStatus = () => {
  ...
  const isHidden = () => {
    const enabledPaths = [PATHS.OVERVIEW, PATHS.REPO, PATHS.DASHBOARD, PATHS.SNIPPETS._, PATHS.SUPPORT, PATHS.PROFILE, PATHS.GUIDES, PATHS.INVITATIONS, PATHS.PERSONAL_INSIGHTS];
    let hidden = true;
