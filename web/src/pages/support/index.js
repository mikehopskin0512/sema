...
const HelpAndSupport = () => {
  ...
  return (
    <div className="pb-150 has-background-white">
      ...
      <div className={clsx(
        'is-flex is-justify-content-space-between is-align-items-stretch is-flex-wrap-wrap',
        styles['animation-container'],
      )}>
        { content.map((item) => {
          const { img, animationData, title, subtitleHtml } = item;
          return(
            <div
              key={title}
