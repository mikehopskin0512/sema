import { create, get, updateItem, update, getAll, deleteItem } from '../../utils/api';
...
export const deleteSnapshotFromPortfolio = (body, token) => update(`/api/proxy/snapshots/remove/${body.snapshotId}`, body, token);
