...
resource "aws_ssm_parameter" "apollo_mongo_uri" {
  ...
  type  = "SecureString"
  value = "mongodb+srv://phoenix_admin:0yvYDIsrxraKsKkQ@sema-cluster.tpplx.mongodb.net/phoenix_qa?retryWrites=true&w=majority"
}
...
resource "aws_ssm_parameter" "github_redirect" {
  ...
  type  = "String"
  value = "https://api-qa.semasoftware.com/v1/identities/github/cb"
}
resource "aws_ssm_parameter" "phoenix_api_endpoint" {
  name  = "/${var.env}/phoenix/api/endpoint"
  type  = "String"
  value = "https://api-qa.semasoftware.com"
}
