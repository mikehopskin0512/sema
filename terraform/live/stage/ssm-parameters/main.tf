...
resource "aws_ssm_parameter" "apollo_mode_access_key" {
  name  = "/${var.env}/apollo/mode/access-key"
  type  = "String"
  value = "a3f7669a55c1c6b0caa8ffc1"
}
resource "aws_ssm_parameter" "apollo_mode_access_secret" {
  name  = "/${var.env}/apollo/mode/access-secret"
  type  = "SecureString"
  value = "bb80ef1a7195f7afaad94a31"
}
resource "aws_ssm_parameter" "apollo_mode_api_key" {
  name  = "/${var.env}/apollo/mode/api-key"
  type  = "String"
  value = "34b345c24570"
}
resource "aws_ssm_parameter" "apollo_mode_api_secret" {
  name  = "/${var.env}/apollo/mode/api-secret"
  type  = "SecureString"
  value = "b7457997376ab9720f3ed71f"
}
resource "aws_ssm_parameter" "apollo_mode_max_age" {
...
resource "aws_ssm_parameter" "apollo_mode_report_id" {
  name  = "/${var.env}/apollo/mode/report-id"
  type  = "String"
  value = "458a98450313"
}
resource "aws_ssm_parameter" "apollo_mongo_cert_path" {
...
resource "aws_ssm_parameter" "apollo_mongo_uri" {
  ...
  type  = "SecureString"
  value = "mongodb+srv://phoenix_admin:DnUKm3vsf3C3zaym@sema-cluster.tpplx.mongodb.net/phoenix_stage?authSource=admin&replicaSet=atlas-bjp57o-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true"
}
resource "aws_ssm_parameter" "apollo_org_domain" {
...
resource "aws_ssm_parameter" "apollo_postgres_public_key" {
  name  = "/${var.env}/apollo/postgres/public-key"
  type  = "SecureString"
  value = "qwuwqx"
}
resource "aws_ssm_parameter" "apollo_sendgrid_api_key" {
...
resource "aws_ssm_parameter" "aws_sns_topic_code_analysis" {
  name  = "/${var.env}/aws/sns/topic/code-analysis"
  type  = "String"
  value = "arn:aws:sns:us-east-1:091235034633:${var.env}-code-analysis-topic"
}
resource "aws_ssm_parameter" "aws_sns_topic_cross_region_replication" {
...
resource "aws_ssm_parameter" "aws_sns_topic_filter_org_replication" {
